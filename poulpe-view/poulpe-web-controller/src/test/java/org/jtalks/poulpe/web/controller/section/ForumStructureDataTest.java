...
//        ForumStructureItem previous = sut.setSelectedItemInTree(item);
...
//        sut.setSelectedItemInTree(branchToPut);
...
//        ForumStructureItem item = new ForumStructureItem();
//        sut.setSelectedItemInTree(item);
//        assertSame(item, sut.setSelectedItemInTree(new ForumStructureItem()));
//    }
//
...
//        sut.setSelectedItemInTree(newSection);
//
...
//        sut.setSelectedItemInTree(selectedNode.getData());
...
//        sut.setSelectedItemInTree(selectedItem);
//        sut.showSectionDialog(false);
//        assertTrue(sut.isShowSectionDialog());
//        assertSame(sut.getSelectedItemInTree(), selectedItem);
//    }
//
//    @Test
...
//        assertTrue(sut.isShowSectionDialog());
//        assertNotSame(sut.getSelectedItemInTree(), selectedItem);
//        assertThat(sut.getSelectedItemInTree().getItem(), instanceOf(PoulpeSection.class));
//    }
//
...
//        assertTrue(sut.getSelectedItemInTree().isBranch());
//        assertEquals(sut.getSelectedItemInTree().getItem().getId(), 0);
//    }
//
//    @Test(dataProvider = "provideTreeModelWithSectionsAndBranches", enabled = false)
...
//        sut.setSelectedItemInTree(new ForumStructureItem(new PoulpeSection()));
//        sut.showSectionDialog(false);
//        assertTrue(sut.isShowSectionDialog());
...
////        BranchEditingDialog branchDialog = new BranchEditingDialog(mock(GroupDao.class), forumStructureVm);
