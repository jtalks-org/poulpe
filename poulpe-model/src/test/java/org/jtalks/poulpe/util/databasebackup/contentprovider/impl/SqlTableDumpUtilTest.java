...
public class SqlTableDumpUtilTest {
    ...
    // assertEquals(DbDumpUtil.joinStrings(list, "").toString(), "123");
    // assertEquals(DbDumpUtil.joinStrings(list, "<separator>").toString(), "1<separator>2<separator>3");
    // }
    ...
    // }
    // try {
    // DbDumpUtil.joinStrings(new ArrayList<String>(), null);
