 ...
 *   </bean>
 *   
 *   <bean id="validatorFactory" class="org.jtalks.common.validation.ContextAwareConstraintValidatorFactory" />
 *   
 *   <bean id="uniqueConstraintValidator" class="org.jtalks.common.validation.UniqueConstraintValidator">
 *       <property name="uniquenessViolatorsRetriever" ref="uniquenessViolatorsRetriever" />
 *   </bean>
 *   
 *   <bean id="uniquenessViolatorsRetriever" class="org.jtalks.common.validation.UniquenessViolatorsRetriever">
